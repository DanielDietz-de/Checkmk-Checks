...
"""Setup ruleset definitions for the alteon_application_switch integration: alteon memory."""
...
def _parameter_valuespec_alteon_memory():
    """Handle parameter valuespec alteon memory for this module's workflow."""
    return Dictionary(
        elements={
