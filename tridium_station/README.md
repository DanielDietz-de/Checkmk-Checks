...
- Canonical package: `tridium_station` version `2.0.1`; minimum Checkmk version `2.4.0b1`; maximum asserted version: not asserted; validate on the target release.
- Canonical manifest: `tridium_station/src/info`; it declares 25 packaged files.
- Repository MKP artifacts present: `TRIDIUM-1.0.mkp`, `TRIDIUM-1.1.mkp`, `tridium_station-1.1.1.mkp`, `tridium_station-2.0.0.mkp`, `tridium_station-2.0.1.mkp`.
- No committed checksum file is present; do not distribute an unverified locally built artifact.
- Source under `src/` is authoritative; generated MKP files and this reference must match it.

### Configuration and components

- **Agent-based checks:** `src/tridium_station/agent_based/tridium_fuel.py`, `src/tridium_station/agent_based/tridium_special.py`, `src/tridium_station/agent_based/tridium_station.py`.
- **Rulesets:** `src/tridium_station/rulesets/tridium.py`.
- **Check manuals:** `src/tridium_station/checkman/tridium_10`, `src/tridium_station/checkman/tridium_11`, `src/tridium_station/checkman/tridium_13`, `src/tridium_station/checkman/tridium_14`, `src/tridium_station/checkman/tridium_15`, `src/tridium_station/checkman/tridium_16`, `src/tridium_station/checkman/tridium_17`, `src/tridium_station/checkman/tridium_19` and 13 more.
- Registered check plug-in names: `tridium_%d`, `tridium_fuel`, `tridium_special`.

### Validation

- Package-specific tests: `tests/test_tridium_station_integrity.py`.
